...
import org.fok.p22p.model.P22P.PBVoteString
import onight.tfw.async.CallBack
import onight.tfw.otransio.api.beans.FramePacket
import org.fok.p22p.model.P22P.PBVoteStringOrBuilder
import org.fok.p22p.model.P22P.PBVoteString.PVOperation

object ExtStringVoter extends Votable with OLog with PMNodeHelper with BitMap {
  // , reallist: List[SecondaryValue]
  def makeDecision(network: Network, pbo: PVBase, reallist: scala.collection.mutable.Map[Array[Byte],Array[Byte]] = null): Option[String] = {
